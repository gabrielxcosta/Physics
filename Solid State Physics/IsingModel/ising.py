...
class AnimatedIsing(Ising):
    ...
    def __set_axes(self):
        ...
        self.ax[0].set(ylabel=r"$i$", xlabel=r"$j$")
...
class DynamicAnimatedIsing(Ising):
    ...
    def __init__(
        ...
        self.colors_palette = sns.color_palette(n_colors=6)
        self.temp_func = temp
    ...
    def __update_ani_time_series(self, frame):
        ...
        self.fig.suptitle(self.__str__())
        self.ax[0].imshow(self.lattice.state, norm=Normalize(vmin=-1.0, vmax=1.0))
        self.ax[1].plot(self.time_hist, self.mean_energy_hist, color=self.colors_palette[0])
        self.ax[2].plot(self.time_hist, self.magnet_hist, color=self.colors_palette[1])
        self.ax[3].plot(self.time_hist, self.specific_heat_hist, color=self.colors_palette[2])
        self.ax[4].plot(self.time_hist, self.susceptibility_hist, color=self.colors_palette[3])
        self.ax[5].plot(self.time_hist, self.temp_hist, color=self.colors_palette[4])
        self.ax[6].plot(self.time_hist, self.field_hist, color=self.colors_palette[5])
    ...
    def __update_ani_no_time_series(self, frame):
        ...
        self.fig.suptitle(self.__str__())
        self.ax[0].imshow(self.lattice.state, norm=Normalize(vmin=-1.0, vmax=1.0))
        self.ax[1].plot(self.time_hist, self.temp_hist, color=self.colors_palette[4])
        self.ax[2].plot(self.time_hist, self.field_hist, color=self.colors_palette[5])